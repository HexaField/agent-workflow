...
const verifierWorkerWorkflowDefinition = workflow('verifier-worker.v1')
  .description('Two-role workflow pairing a worker and verifier with iterative feedback.')
  .model('github-copilot/gpt-5-mini')
  .session('worker', '{{runId}}-worker')
...
export { verifierWorkerWorkflowDefinition }
export const verifierWorkerWorkflowDocument = verifierWorkerWorkflowDefinition
