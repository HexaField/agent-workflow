...
const workflowCreateWorkflowDefinition = workflow('workflow-create.v1')
  .description(
  ...
  .round((round) =>
    round
      ...
      .defaultOutcome('created', 'Single-step authoring workflow completed')
      .maxRounds(1)
  )
  .build()

export { workflowCreateWorkflowDefinition }
export const workflowCreateWorkflowDocument = workflowCreateWorkflowDefinition
